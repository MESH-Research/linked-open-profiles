 ...
 */
 ...
 function create_block_orcid_data_block_2_block_init() {
    wp_register_script(
        'create-block-orcid-data-block-2-editor-script',
        plugins_url( 'build/index.js', __FILE__ ),
        array( 'wp-blocks', 'wp-element', 'wp-editor', 'wp-i18n' ),
        filemtime( plugin_dir_path( __FILE__ ) . 'build/index.js' )
    );
    wp_set_script_translations( 'create-block-orcid-data-block-2-editor-script', 'orcid-data-block-2', plugin_dir_path( __FILE__ ) . 'languages' );
	register_block_type( __DIR__ . '/build',
    [
        'editor_script' => 'create-block-orcid-data-block-2-editor-script',
    ],
    );
}
